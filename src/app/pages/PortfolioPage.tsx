...
export function PortfolioPage() {
    ...
    useEffect(() => {
        document.title = "Kumpulan Portofolio Jasa Pembuatan Website Bali | BangBisnis";
        const metaDesc = document.querySelector('meta[name="description"]');
        if (metaDesc) {
            metaDesc.setAttribute("content", "Lihat portofolio desain website kami. BangBisnis membantu puluhan UMKM dan perusahaan Bali tampil profesional dengan website elegan & modern.");
        }
    }, []);
