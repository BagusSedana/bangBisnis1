...
const testimonials = [
    ...
    },
    {
        name: "Ketut Astawa",
        role: "Owner",
        business: "TravelJimb — Private Driver",
        location: "Jimbaran, Bali",
        avatar: "KA",
        color: "#0ea5e9",
        rating: 5,
        text: "Mendapatkan website dengan desain premium ini sangat membantu meyakinkan target market turis asing saya. Fitur tombol WhatsApp-nya membuat tamu lebih mudah langsung booking mobil. Sangat profesional.",
        result: "Booking tour naik 2x lipat",
    },
    {
